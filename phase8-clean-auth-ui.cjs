    ...
    return (
      <section className="panel auth-panel clean-auth logged-in-card">
        <div>
          ...
          <p className="form-note">Your dashboard and menu are now based on your saved SoloHub role.</p>
        </div>
...
// Remove onRoleChange from HomePage usage in AuthBox call, but keep prop harmlessly if still passed
code = code.replace(
...
// Update hero text from old Phase 3 language
...
console.log("? Phase 8 clean auth UI patch applied.");

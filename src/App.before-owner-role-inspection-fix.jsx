...
function App() {
  ...
  const loadProfile = async (currentUser, preferredRole = 'clipper', fullName = '') => {
    ...
    try {
      ...
      const ownerEmails = ['mayorkunda254@gmail.com'];
      ...
      // Owner override: your email is always admin.
      // Existing DB role wins for everyone else.
      const finalRole = isOwnerAdmin
        ? 'admin'
        : savedRole || requestedRole || metadataRole || 'clipper';
      ...
      const cleanFinalRole = isOwnerAdmin ? 'admin' : cleanRole(savedProfile.role || finalRole);
      const finalProfile = { ...savedProfile, role: cleanFinalRole };
